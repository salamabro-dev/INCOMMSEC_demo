    ...
    <div className="lg:col-span-6">
      <form className="" onSubmit={onSubmit}>
        <fieldset className="flex flex-col gap-y-8 pb-20">
          <div className="flex flex-col">
            <label
              className="text-primary-grey-neutral-p2 pb-4 text-base"
              htmlFor="name"
            >
              Your Name:
            </label>
          ...
          <div className="flex justify-center">
            <button
              className="text-lg w-9/12 banner-btn rounded-full my-2 py-4 px-10 text-white flex items-center justify-center w-full text-base"
              type="submit"
            >
              Submit
              <ArrowForwardIcon
